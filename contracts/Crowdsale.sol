...
contract TheAbyssDAICO is Ownable, SafeMath, Pausable, ISimpleCrowdsale {
    ...
    uint256 public constant SALE_START_TIME = 1524727800; // Thu, 26 Apr 2018 09:30:00 +0200
    uint256 public constant SALE_END_TIME = 1526904933; // Mon, 21 May 2018 14:15:33 +0200
    ...
    uint256 public hardCap = 34615 ether; // World hard cap will be set right before Token Sale
    uint256 public softCap = 11538 ether; // World soft cap will be set right before Token Sale
